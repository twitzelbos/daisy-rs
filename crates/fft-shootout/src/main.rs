...
const R_DONE: isize = 15; // 0xD09E = all benches ran (kept clear of the value slots)
const DONE_SENTINEL: u32 = 0x0000_D09E;

// --- DTCM scratch (max N = 2048; complex length L = 1024) --------------------
static mut IN: [f32; 2048] = [0.0; 2048];
static mut SRE: [f32; 1024] = [0.0; 1024];
static mut SIM: [f32; 1024] = [0.0; 1024];
